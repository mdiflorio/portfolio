export const about_EN = `Current freelance React Native developer and computer science
...
export const about_body_FR = ` french french french french french frenchfrenchfrenchfrenchfrenchfrenchfrenchfrench`;

export const interests_EN = `Enjoys building new products and working with teams of motivated
people. Loves cooking and travelling around the world when possible.`;

export const seeking_EN = `Currently seeking a one-year internship for a
Licence Professionnelle in France, 2019-2020.`;
